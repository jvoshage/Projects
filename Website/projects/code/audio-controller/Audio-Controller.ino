...
const char* feed = "**********";                //This is the channel where the commands come in
const char* stateFeed = "**********/state";     //This is the channel where the device talks to NORA
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  {
    char buff[16];
    sprintf(buff, "IP: %d.%d.%d.%d   Sketch: Audio-Controller",WiFi.localIP()[0],WiFi.localIP()[1],WiFi.localIP()[2],WiFi.localIP()[3]);
